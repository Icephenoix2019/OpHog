...
( function() {
    ...
    window.game.ItemType = {
        ...
        RANDOM_WEAPON: {
            ...
            itemLevel:2,
            atk: [-8,8],
            name:'Randomized Dagger',
            flavorText:'A dagger that is completly randomized.',
            graphicIndex: game.Graphic.WHITE_KNIFE,
            equippableBy: game.EquippableBy.ALL,
            sellPrice: 2,
        },
        RANDOM_ACC: {
        ...
        RANDOM_WEAPON_3: {
            ...
            itemLevel:10,
            atk: [-28,28],
            name:'Randomized Dagger Lvl 3',
            flavorText:'A dagger that is completly randomized. Now Lvl 3.',
            graphicIndex: game.Graphic.WHITE_KNIFE,
            equippableBy: game.EquippableBy.ALL,
            sellPrice: 10,
        },
