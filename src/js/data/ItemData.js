...
( function() {
    ...
    window.game.ItemType = {
        ...
        PALADIN_HAMMER: {
            ...
            flavorText:'Deals Heavy Damage, but has no bonus effect.',
            graphicIndex: game.Graphic.SILVER_HAMMER,
            equippableBy: game.EquippableBy.WAR,
            sellPrice: 100,
        },
        HEAVENS_HAMMER: {
            ...
            flavorText:'Deals Wonderous Damage, but has no bonus effect.',
            graphicIndex: game.Graphic.YELLOW_HAMMER,
            equippableBy: game.EquippableBy.WAR,
            sellPrice: 120,
        },
        TRUE_HAMMER: {
            ...
            atk:[30,120],
            name:'True Hammer',
            flavorText:'Deals MAX Damage, but has no bonus effect.',
            graphicIndex: game.Graphic.YELLOW_HAMMER,
            equippableBy: game.EquippableBy.WAR,
            sellPrice: 180,
        },
        ...
        RANDOM_WEAPON: {
            ...
            itemLevel:2,
            atk: [-8,8],
            name:'Randomized Sword',
            flavorText:'A sword that is completly randomized.',
            graphicIndex: game.Graphic.RANDOM_SWORD,
            equippableBy: game.EquippableBy.ALL,
            sellPrice: 2,
        },
        RANDOM_ACC: {
            ...
            def:[-2,2],
            life:[-15,15],
            name:'Randomized Ring',
            flavorText:'A ring that is completly randomized.',
            graphicIndex: game.Graphic.EMERALD_RING,
            equippableBy: game.EquippableBy.ALL,
            sellPrice: 2,
        },
        RANDOM_WEAPON_2: {
            ...
            itemLevel:5,
            atk: [-16,16],
            name:'Randomized Sword Lvl 2',
            flavorText:'A sword that is completly randomized. Now Lvl 2.',
            graphicIndex: game.Graphic.RANDOM_SWORD,
            equippableBy: game.EquippableBy.ALL,
            sellPrice: 5,
        },
        RANDOM_ACC_2: {
            ...
            def:[-6,6],
            life:[-40,40],
            name:'Randomized Ring Lvl 2',
            flavorText:'A ring that is completly randomized. Now Lvl 2.',
            graphicIndex: game.Graphic.EMERALD_RING,
            equippableBy: game.EquippableBy.ALL,
            sellPrice: 5,
        },
        RANDOM_WEAPON_3: {
            ...
            itemLevel:10,
            atk: [-28,28],
            name:'Randomized Sword Lvl 3',
            flavorText:'A sword that is completly randomized. Now Lvl 3.',
            graphicIndex: game.Graphic.RANDOM_SWORD,
            equippableBy: game.EquippableBy.ALL,
            sellPrice: 10,
        },
        ...
        POISON_QUIVER: {
            ...
            atk: [2,2],
            name:'Poison Arrows',
            flavorText:'Infused with poison which deals weak damage over time.',
            graphicIndex: game.Graphic.GREEN_QUIVER,
            equippableBy: game.EquippableBy.ARCH,
            sellPrice: 80,
            mods:[new game.Poison(.25)]
        },
        VENOM_QUIVER: {
            ...
            atk: [5,5],
            name:'Venom Arrows',
            flavorText:'Infused with venom which deals Heavy damage over time.',
            graphicIndex: game.Graphic.PURPLE_QUIVER,
            equippableBy: game.EquippableBy.ARCH,
            sellPrice: 120,
            mods:[new game.Poison(.40)]
        },
    };
